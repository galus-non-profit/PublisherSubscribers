namespace SubscriberIFC.Infrastructure.MassTransit;

using System.Security.Authentication;
using global::MassTransit;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using SubscriberIFC.Infrastructure.MassTransit.Files.Consumers;
...
internal static class DependencyInjection
{
    public static IServiceCollection AddMassTransit(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        {
            configure.AddConsumer<ProcessNewFileConsumer>().Endpoint(endpoint => endpoint.InstanceId = "subscriberIFC");
